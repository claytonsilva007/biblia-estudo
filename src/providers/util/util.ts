...
export class UtilProvider {
  ...
  popularVersiculosDaSorte() {
    ...
    this.versiculos.push("Ef. 6.13 - Por isso, vistam toda a armadura de Deus, para que possam resistir no dia mau e permanecer inabaláveis, depois de terem feito tudo");
